...
const pImgs = document.querySelectorAll('.proyect-imgs');
...
const clickModal = document.getElementsByClassName('layout');
const contentModal = document.getElementsByClassName('content-modal');
const btnCloseModal = document.getElementsByClassName('btn__modal--close');

// const modals = new Array(contentModal);
// console.log(clickModal);

function openModal() {
    Object.values(clickModal).forEach((modal, index) => {
        // console.log(modal);

        btnCloseModal[index].addEventListener('click', () => {
            contentModal[index].classList.toggle('show-modal');
        });
